...
public class PartitionInfoTest {
  ...
  public void testEncodeAndDecodeValid() {
    ...
    assertEquals(decoded.getLastRefreshMs(), 1700006400000L);
  ...
  public void testEncodeAndDecodeStale() {
    ...
    assertEquals(decoded.getLastRefreshMs(), 0L);
    assertEquals(decoded, info);
  }
  ...
  public void testWithState() {
    ...
    assertEquals(stale.getLastRefreshMs(), 1000L);
  ...
  public void testFromLegacyFingerprint() {
    ...
    assertEquals(info.getLastRefreshMs(), 0L);
  }
  ...
  public void testToString() {
    ...
    assertTrue(str.contains("lastRefreshMs=999"));
  }
}
