 ...
 * by implementing this interface and registering with {@link MvQueryRewriteEngine}.
 */
public interface MvMatchStrategy {
   ...
   * @return a {@link MvMatchResult} if the MV can answer the user query, {@code null} otherwise
   */
  @Nullable
  MvMatchResult match(PinotQuery userQuery, MvMetadataCache.MvCacheEntry candidateEntry);
}
