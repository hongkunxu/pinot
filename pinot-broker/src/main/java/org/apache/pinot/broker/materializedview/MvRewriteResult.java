...
public class MvRewriteResult {
  ...
  @Nullable
  private final MvMatchResult _matchResult;

  public MvRewriteResult(List<String> candidateNames, @Nullable MvMatchResult matchResult) {
  ...
  @Nullable
  public MvMatchResult getMatchResult() {
    return _matchResult;
  }
  ...
  public String getHitMvName() {
    return _matchResult != null ? _matchResult.getMvTableName() : null;
  }
}
